    ...
    <div className="content pb-0">
      ...
      <div className="card border-0 rounded-0">
        <div className="card-header d-flex justify-content-between">
          <input type="text" className="form-control w-50" placeholder="Search stores..." />

{/* <Link href="/master/seller-store/store-branding"> */}

          <button onClick={() => router.push("/master/seller-store/store-branding")} className="btn btn-primary">Add New Store </button>
{/* </Link> */}
        </div>
