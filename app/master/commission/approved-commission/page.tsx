...
const initialCommissions = [
  ...
  { id: 4, product: 'Dell UltraSharp 27” Monitor', type: 'Percentage', value: 6, status: 'approved', created_at: '2024-11-02T11:00:00Z' },
];
...
const page = () => {
  ...
  const paginated = useMemo(() => {
    ...
    return approvedCommissions.slice(start, start + entriesPerPage);
  }, [approvedCommissions, currentPage, entriesPerPage]);

  const totalPages = Math.ceil(approvedCommissions.length / entriesPerPage);
  ...
  return (
    <div className="container py-4">
      <h1 className="mb-4 fw-bold">Approved Commissions</h1>
