            ...
            <ul>
              ...
              <li>
                <ul>
                  <li
                    className={
                      checkActive("/seller/dashboard/overview")
                        ? "active"
                        : ""
                    }
                  >
                  ...
                  <li
                    className={
                      checkActive("/seller/dashboard/orders-summary")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/dashboard/orders-summary">
                      <i className="ti ti-users" />
                  ...
                  <li
                    className={
                      checkActive("/seller/dashboard/top-products")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/dashboard/top-products">
              ...
              <li>
                <ul>
                  <li
                    className={
                      checkActive("/seller/products/all-products") ? "active" : ""
                    }
                  >
                    <Link href="/seller/products/all-products">
                      <i className="ti ti-users" />
                  ...
                  <li
                    className={
                      checkActive("/seller/products/add-products")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/products/add-products">
                      <i className="ti ti-users" />
                  ...
                  <li
                    className={
                      checkActive("/seller/products/pending-review")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/products/pending-review">
                      <i className="ti ti-user-shield" />
                  ...
                  <li
                    className={
                      checkActive("/seller/products/disabled-products")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/products/disabled-products">
                      <i className="ti ti-user-shield" />
                  ...
                  <li
                    className={
                      checkActive("/seller/products/draft-products")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/products/draft-products">
                      <i className="ti ti-user-shield" />
              ...
              <li>
                <ul>
                  ...
                  >
                    <Link href="/seller/orders/all-orders">
                      <i className="ti ti-users" />
                  ...
                  <li
                    className={
                      checkActive("/seller/orders/pending-orders")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/orders/pending-orders">
                      <i className="ti ti-users" />
                  ...
                  <li
                    className={
                      checkActive("/seller/orders/processing-orders")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/orders/processing-orders">
                      <i className="ti ti-users" />
                  ...
                  <li
                    className={
                      checkActive("/seller/orders/ready-to-ship")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/orders/ready-to-ship">
                      <i className="ti ti-user-shield" />
              ...
              <li>
                <ul>
                  <li
                    className={
                      checkActive("/seller/inventory/out-of-stock")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/inventory/out-of-stock">
                      <i className="ti ti-users" />
                  ...
                  <li
                    className={
                      checkActive("/seller/inventory/stock-list")
                        ? "active"
                        : ""
                    }
                  >
                    <Link href="/seller/inventory/stock-list">
                      <i className="ti ti-users" />
